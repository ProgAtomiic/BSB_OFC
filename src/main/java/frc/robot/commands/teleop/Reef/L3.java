...
public class L3 extends Command {
  ...
  public L3(ElevatorSubsystem Elevator, ArmSubsystem armSubsystem, SwerveSubsystem swerveSubsystem, LevelSet levelSet, XboxController Controller) {
        ...
        case 1:
          ...
          if (ElevatorSubsystem.GetPosicaoElevador() > 7) {
            ...
            if (ArmSubsystem.angleget() > 160 && ArmSubsystem.angleget() < 177
                && ElevatorSubsystem.GetPosicaoElevador() > 28 && ElevatorSubsystem.GetPosicaoElevador() < 32) {
              Parte1 = 0;
